...
- `Turn Transition Window (s)`: sets the maximum accumulation span from the first active
  ...
  endpoint X correction releases with a quintic curve (up to 0.5 seconds) back to the underlying path;
