...
- Version `1.1.34` applies the full causal Turn path to prepared playback as well as per-frame rendering, so continuous pans use their configured Turn Window authority.
