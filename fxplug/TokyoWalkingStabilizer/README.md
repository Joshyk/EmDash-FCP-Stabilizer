...
- Version `1.1.23` keeps the all-axis Camera Jitter baseline on schema 51 and applies supported frame-local rigid X/Y/roll without a playback slew ramp or fixed low source-pixel Y cap.
