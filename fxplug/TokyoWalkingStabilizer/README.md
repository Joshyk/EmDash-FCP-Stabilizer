...
- `Auto Crop Hold Time`: default `4` seconds, range `0...30` seconds. This
  ...
  residual zoom delta to about one quarter, so subtle or nearly idle sections do
  ...
  seconds, Auto Crop returns to identity so idle shots settle near zero crop
  zoom.
