...
- Version `1.1.30` keeps the all-axis Camera Jitter baseline on schema 51, adds an independent Turn Transition Window control, and removes the output-width Turn X cap.
