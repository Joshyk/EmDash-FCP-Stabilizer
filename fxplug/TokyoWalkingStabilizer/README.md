...
- Version `1.1.31` keeps the schema 51 Camera Jitter cache, makes Turn Transition Window own the pan grouping evidence, and makes Crop-off a true 1.0x/no-reservation diagnostic mode.
