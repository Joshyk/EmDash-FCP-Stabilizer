...
- Version `1.1.33` keeps schema 51, applies Turn across continuous X pans, pre-rolls curves by up to 30%, and prevents Camera Jitter X from becoming a second pan owner.
