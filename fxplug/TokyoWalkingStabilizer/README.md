...
- Version `1.2.1` maps Turn Smoothing Strength linearly in viewport space: 12 equals the former 36 result and 36 applies three times that zoom and X movement. Auto Crop Zoom-In and Zoom-Out default to 6 seconds and Hold remains between them.
