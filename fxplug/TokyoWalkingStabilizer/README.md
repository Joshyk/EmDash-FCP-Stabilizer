...
- Version `1.1.32` keeps schema 51 and makes Turn Window use a causal pan-history path, so a long continuous pan has visible Turn X authority at high strength.
