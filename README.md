...
reports no media folder. Active library bookmarks are resolved as regular bookmarks first,
then retained with security-scoped access only when the resolved URL grants it.
