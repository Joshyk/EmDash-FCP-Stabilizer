...
frame's full luma sample. Schema 42 is required so render can suppress older
local band-warp production paths when rigid far-field evidence is available;
older schemas must be regenerated by the Event Analyzer.
