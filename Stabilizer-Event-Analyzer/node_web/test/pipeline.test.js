...
function analysisResult(assetId = "r2", name = "P1000307") {
  return {
    ...
    cacheIdentity: `51:0:6006:20:1920:1080:300:aaa:bbb:ccc:end6006:${name}`,
    cacheSchemaVersion: 51,
...
`,
  ...
  assert.match(path.basename(pkg.packageDirectory), /^LibraryClip__schema51__sample10__frames300__[0-9a-f]{8}$/);
  ...
  fs.writeFileSync(
    ...
    JSON.stringify({
      ...
      results: [
        {
          assetId: "r2",
          cacheIdentity: "51:0:6006:20:1920:1080:300:aaa:bbb:ccc:end6006:P1000307",
          cacheSchemaVersion: 51,
...
test("build_stabilizer_fcpxml_import emits one package directory per footage", () => {
  ...
  assert.match(path.basename(pkg.packageDirectory), /^P1000307__schema51__sample10__frames300__[0-9a-f]{8}$/);
...
test("build_stabilizer_fcpxml_import reuses deterministic package directory for matching analysis", () => {
  ...
  assert.match(path.basename(second.packages[0].packageDirectory), /^P1000307__schema51__sample10__frames300__[0-9a-f]{8}$/);
...
test("build_stabilizer_fcpxml_import separates deterministic package directories by identity", () => {
  ...
  const changed = {
    ...result,
    cacheIdentity: "51:0:6006:20:1920:1080:300:ddd:eee:fff:end6006:P1000307",
