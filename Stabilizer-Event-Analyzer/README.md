...
kernels. Schema 49 analysis persists a `5x9` far-field mesh plus fps-derived
...
now accepts schema 49 only; earlier caches must be regenerated by the Event
Analyzer. Version `1.1.19` makes this axis-specific detector and original-media
