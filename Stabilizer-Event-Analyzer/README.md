...
kernels. Schema 51 analysis persists a `5x9` far-field mesh plus fps-derived
...
now accepts schema 51 only; earlier caches must be regenerated by the Event
Analyzer. Version `1.1.26` reuses schema 51 and applies Inspector Camera Rigid
